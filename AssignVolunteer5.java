...
public class AssignVolunteer5
{
	public static void main(String[] args) 
	{
		...
		System.out.print("Enter " + CLOTHING_CODE + " for CLOTHING, " + FURNITURE_CODE + " for FURNITURE, " + ELECTRONICS_CODE + " for ELECTRONICS, or " + OTHER_CODE + " for ANYTHING ELSE >> ");
